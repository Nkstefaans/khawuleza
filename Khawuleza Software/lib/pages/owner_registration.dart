...
//   @override
//   State<OwnerRegistration> createState() => OwnerRegistrationState();
// }

// class OwnerRegistrationState extends State<OwnerRegistration> {
...
//               const SizedBox(height: 10),
//               const MyTextField(
//                 hintText: "Taxi association umber",
//                 maxLength: 10,
//               ),
//               const SizedBox(height: 10),
//               const MyTextField(
...
class OwnerRegistrationState extends State<OwnerRegistration> {
  ...
  final TextEditingController _taxiAssociationNumberController =
  ...
  void registerUser() async {
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'email': _emailController.text.trim(),
        'userType': 'owner', // Set the user type
